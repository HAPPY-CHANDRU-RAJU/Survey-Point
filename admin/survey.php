...
<?php include_once'nav.php'; ?>  
	<div class="alert alert-info alert-dismissible">
		<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
			<h3><b>Check out Surveys details !!!</b></h3>
	</div>
		...
		<div class="row">
			...
			<div class="col-sm-10" style="overflow: scroll;height: 500px;">
				<table class="table table-responsive">
					...
					$qs1 = "SELECT * FROM `Survey_Activty` ORDER BY `Survey_Act_DOC` DESC";
					...
					while($row2 = $rs23->fetch()){
						...
						<td><button class="btn btn-sm btn-<?php echo $cole; ?>" onclick="location.href='?source_um=accept&action=<?php echo $stat; ?>&&Activity_Id=<?php echo $row2["Survey_Act_Id"]; ?>'">
									<?php echo $display; ?>
						</button></td>
					<?php
					echo '</tr>';
